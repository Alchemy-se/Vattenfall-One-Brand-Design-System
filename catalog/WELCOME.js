      ...
      <div>
        ...
        <div className={styles.startPageHero}>
          ...
          <div className={styles.videoContainer}>
            <video autoPlay loop>
              <source src="/img/example-startpage/hero-video.mp4" type="video/mp4" />
            </video>
          </div>
          <h1>
        ...
        <div className={styles.introText}>
          <div>Vattenfall Design System unites products & services around a common visual language. It aims to reduce
            current Design Debt, accelerates the design process, and builds bridges between teams working in concert to
        ...
        <div className={styles.brandStyleGuideContainer}>
          ...
          <div className={styles.text}>
            ...
            logotype, <br /> colors and such? Then you will find everything you need over at <a
