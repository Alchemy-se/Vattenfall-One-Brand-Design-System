          ...
          <div className='vf-two-column-boxes__body'>
            ...
            <div className='vf-two-column-boxes__content'>
              <p className='vf-two-column-boxes__paragraph'>
                We see things in a broader perspective: the need to power the
                change to fossil free fuels beyond our own production and
                committed to act on it on a much broader scale.
