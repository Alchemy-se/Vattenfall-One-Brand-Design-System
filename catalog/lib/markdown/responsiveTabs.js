  ...
  renderSizeIcon = (name) => {
    switch (name) {
      case "Phone": {
        return (
          <svg viewBox="0 0 2 2">
            <rect className="catalog-11861ax-Preview-className" width="0.5622188905547226" height="1"
                  x="0.7188905547226387" y="0.5"></rect>
          </svg>
        );
      }
      case "Tablet": {
      ...
      case "Desktop": {
        return (
          <svg viewBox="0 0 2 2">
            <rect className="catalog-11861ax-Preview-className" width="1.7777777777777777" height="1"
                  x="0.11111111111111116" y="0.5"></rect>
          </svg>
        );
      }
      default: {
