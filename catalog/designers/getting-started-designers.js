...
const Designers = () => (
  <div style= {{ padding: '40px', width: '70%'}}>
    ...
    <iframe style={{marginTop: '40px'}} src="https://player.vimeo.com/video/305508035?color=ffda00&title=0&byline=0&portrait=0" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
<p><a href="https://vimeo.com/305508035">Horizon: Abstract &amp; Sketch Walkthrough</a> from <a href="https://vimeo.com/alchemyse">Alchemy</a> on <a href="https://vimeo.com">Vimeo</a>.</p>
    ...
    <iframe style={{marginTop: '40px'}}src="https://player.vimeo.com/video/305756714?color=ffda00&title=0&byline=0&portrait=0" width="640" height="400" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
<p><a href="https://vimeo.com/305756714">Vattenfall Design Kit</a> from <a href="https://vimeo.com/alchemyse">Alchemy</a> on <a href="https://vimeo.com">Vimeo</a>.</p>
    ...
    <div class="vf-row">
     ...
     <div>
       <img class="is-content" src="https://clients.alchemy.se/vattenfall/wp-content/uploads/2018/12/structure-1.png" width="50%" alt="structure" caption="" data-width="original" data-scaling="no"></img></div>
     <div>
       <br></br>
       <img class="is-content" src="https://clients.alchemy.se/vattenfall/wp-content/uploads/2018/12/500-2.png" width="50%" alt="500" caption="" data-width="original" data-scaling="no"></img></div>
    </div> 
  </div> 
)
