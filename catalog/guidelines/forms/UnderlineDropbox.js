    ...
    <Fragment>
      ...
      <div className={`vf-row ${styles.openDropdownMinHeight}`}>
        <Column title={'Default'}>
          <div
            className={`vf-dropdown vf-dropdown--underline ${styles.fullWidth}`}
        ...
        <Column title={'Hover'}>
          <div
            className={`vf-dropdown vf-dropdown--underline ${styles.fullWidth} ${styles.underlineDropboxHover}`}
          >
        ...
        <Column title={'Focus'}>
          ...
          >
            ...
            <div className='vf-dropdown-list'>
              ...
              <div
                className={`vf-dropdown-list-item ${styles.underlineDropboxSelectedOption}`}
              >
                <label className='vf-dropdown-option'>Spring</label>
              </div>
              <div className='vf-dropdown-list-item'>
