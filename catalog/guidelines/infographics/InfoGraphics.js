...
const InfoGraphics = () => {
  return (
    <Fragment>
      ...
      <div className='vf-row'>
        <div className='vf-col-12'>
          <h2 className='use-in-toc'>Graph colours</h2>
          <p className={`${styles.guidelinesText}`}>
            When creating information graphics mainly use the secondary colours,
            but the primary colours are also allowed. There is also a colour
            palette specifically made for the different energy sources. Please
            look further down on this page to see how to use these colours and
            to find the colour codes. The colour black is only used in text and
            lines, not as a colour in the graph or chart.
          </p>
        </div>
      </div>
      <div className='vf-row'>
      ...
      <div className='vf-row'>
        <ColourSpec
          name='Vattenfall Dark Green'
          hex='#235A60'
          rgb='35, 90, 96'
        />
        <ColourSpec
          name='Vattenfall Dark Blue'
          hex='#22314C'
          rgb='34, 49, 76'
        />
      ...
      <div className='vf-row'>
        ...
        <ColourSpec
          name='Vattenfall Purple'
          hex='#9365BC'
          rgb='147, 101, 188'
        />
        <ColourSpec
          name='Vattenfall Dark Purple'
          hex='#7A2B49'
          rgb='122, 43, 73'
        />
      </div>
      <div className='vf-row'>
        <div className='vf-col-12'>
          ...
          <p className={`${styles.guidelinesText}`}>
            ...
            compliance use the categories: Renewable, Nuclear, District heating
            and Fossil.
          </p>
        </div>
      </div>
      ...
      <div className='vf-row'>
        <div className='vf-col-12'>
          ...
          <p className={`${styles.guidelinesText}`}>
            When creating information graphics mainly use the secondary colours,
            but the primary colours are also allowed. Either create graphics
            using colour tones in the same colour range or use colours in the
            same category: secondary, primary or energy source colours.
          </p>
        </div>
      </div>
      <div className='vf-row'>
      ...
      <div className='vf-row'>
        <div className='vf-col-12'>
          <p className={`${styles.guidelinesText}`}>
            Always make sure that the colours used harmonize with each other.
            Use as few colours as possible to make graphs visibly balanced.
          </p>
        </div>
      </div>
      <div className='vf-row'>
      ...
      <div className='vf-row'>
        <div className='vf-col-12'>
          <p className={`${styles.guidelinesText}`}>
            Avoid mixing colors from different categories. Also avoid creating
            graphs with colors that have too much contrast against each other.
          </p>
        </div>
      </div>
      <div className='vf-row'>
      ...
      <div className='vf-row'>
        <div className='vf-col-12'>
          ...
          <p className={`${styles.guidelinesText}`}>
            ...
            exemplified below but you can use any of the primary or secondary
            colours as a base.
          </p>
        </div>
      </div>
      ...
      <div className='vf-row'>
        <div className='vf-col-12'>
          ...
          <p className={`${styles.guidelinesText}`}>
            ...
            background. Do not place multi-coloured graphs on coloured
            backgrounds.
          </p>
        </div>
      </div>
      ...
      <div className='vf-row'>
        <div className='vf-col-12'>
          ...
          <p className={`${styles.guidelinesText}`}>
            Infographics refers to the visualization of data in graphs, tables
            and numbers. Through our motion ID philosophy of “ease-in-out”,
            infographics become the most powerful examples of our identity in
            motion as we here allow a graph or number to develop in a smooth,
            controlled “easing” movement with a high-quality perception.
          </p>
          <p className={`${styles.guidelinesText}`}>
            To read more about the “ease-in-out” motion ID philosophy, please
            see the description in the Video &amp; Motion guidelines chapter.
          </p>
        </div>
      </div>
    </Fragment>
