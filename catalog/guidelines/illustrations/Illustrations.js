    ...
    <Fragment>
      ...
      <div className="vf-row">
        <div className="vf-col-12">
          ...
          <p className={`${styles.guidelinesText}`}>
            To illustrate new isometric illustrations you can use the grid below. You find it under Utility / Isometric Grid - Illustrations.
          </p>
        </div>
      </div>
      <div className="vf-row">
      ...
      <div className="vf-row">
        <div className="vf-col-12">
          ...
          <p className={`${styles.guidelinesText}`}>
          All approved illustrations and animations can be found in the Media Bank. {" "}<a target="_blank" rel="nofollow noopener" href="https://brandtoolbox.vattenfall.com/media/">https://brandtoolbox.vattenfall.com/media/ </a>
          You can search directly in the search bar and refine your search using the search tools. All illustrations are tagged with relevant words. By clicking on an illustration, size and format information will appear under Basics. 
          The illustrations are available in an SVG format with an attached open Adobe Illustrator PDF file. Information regarding description, usage rights and creator can be found in the Metadata. 
