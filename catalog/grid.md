...
You can offset grid columns in two ways: our responsive `.offset-` grid classes and our [margin utilities](/docs/utilities/spacing/). Grid classes are sized to match columns while margins are more useful for quick layouts where the width of the offset is variable.

#### Offset classes

Move columns to the right using `.offset-md-*` classes. These classes increase the left margin of a column by `*` columns. For example, `.offset-md-4` moves `.vf-col-md-4` over four columns.

```html
<div class="vf-row">
  <div class="vf-col-md-4">.vf-col-md-4</div>
  <div class="vf-col-md-4 offset-md-4">.vf-col-md-4 .offset-md-4</div>
</div>
<div class="vf-row">
  <div class="vf-col-md-3 offset-md-3">.vf-col-md-3 .offset-md-3</div>
  <div class="vf-col-md-3 offset-md-3">.vf-col-md-3 .offset-md-3</div>
</div>
<div class="vf-row">
  <div class="vf-col-md-6 offset-md-3">.vf-col-md-6 .offset-md-3</div>
</div>
```
...
<div class="vf-row">
  ...
  <div class="vf-col-sm-5 offset-sm-2 vf-col-md-6 offset-md-0">.vf-col-sm-5 .offset-sm-2 .vf-col-md-6 .offset-md-0</div>
</div>

<div class="vf-row">
  <div class="vf-col-sm-6 vf-col-md-5 vf-col-lg-6">.vf-col-sm-6 .vf-col-md-5 .vf-col-lg-6</div>
  <div class="vf-col-sm-6 vf-col-md-5 offset-md-2 vf-col-lg-6 offset-lg-0">.vf-col-sm-6 .vf-col-md-5 .offset-md-2 .vf-col-lg-6 .offset-lg-0</div>
</div>
```
